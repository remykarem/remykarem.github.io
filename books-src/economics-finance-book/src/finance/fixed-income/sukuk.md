...
A **certificate** that grants the holder a _share_ of an **asset**, where the holder is entitled to regular cash flows based on the underlying asset's performance (rather than based on a fixed interest rate).
