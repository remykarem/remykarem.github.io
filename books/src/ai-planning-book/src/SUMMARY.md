...
- [Learning to plan in a stochastic environment](./learning-to-plan-in-a-stochastic-environment.md)
    - [Learning the Q-function (model-free RL)](./learning-the-q-function.md)
        - [MC learning]()
            - [Direct utility estimation](./direct-utility-estimation.md)
            - [MC control with GPI](./mc-control-with-gpi.md)
            - [GLIE epsilon-greedy MC control](./glie-epsilon-greedy-mc-control.md)
...
- [Planning in a multi-agent environment](./planning-in-a-multi-agent-environment.md)
    - [Single-move / simultaneous games](./single-move-games.md)
        ...
        - [2-player zero-sum games](./2-player-zero-sum-games.md)
...
- [Multi-armed bandit problem](./multi-armed-bandit-problem.md)
- [Characteristics of learning](./characteristics-of-learning.md)
